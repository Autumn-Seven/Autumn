<template>
    <div v-loading="loading2" element-loading-text="加载中">
        ...
        <el-row>
            <el-col :span='24'>
                <el-table
                        style='width:100%' align="center" :data="articleLists" v-loading="listLoading"
                    ...
                    <el-table-column min-width="180" label="操作">
                        <template scope='scope'>
                            ...
                            <el-button size="small" type='primary' prop="id" @click="editArticle(scope.row.id)">编辑
                            </el-button>
                            <el-button size="small" type='danger' @click="remove(scope.row.id,scope.$index)">删除
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
